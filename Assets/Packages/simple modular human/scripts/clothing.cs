...
public class clothing : MonoBehaviour
{
    ...
    public int skin_color_public; 
    public int male_female_public; // 0 ou 1
    public int hairColor_public; // 0 = dark  1 = brown  2 = blonde
    public int hair_public; //0 a 2
    public int hair_cut_public; //0 ou 1
    public int percent_public; // 0 a 99
    public int suit_or_cloth_public; //0 ou 1
    public int which_suit_public; //0 a 10
          // bankersuit    0
          // cocksuit      1
          // farmersuit    2
          // firemansuit   3
          ...
          // sellersuit    9
          // workersuit    10
    public int which_texture_public; //0 a 7
    public int shoes_public; //0 a 2
    public int shoes1_texture_public; //0 a 7
    public int shoes2_texture_public; //0 a 6
    public int shoes3_texture_public; //0 a 5
    public int chain_public; //0 a 2   
    public int scarfPercentage_public; //0 a 99
    public int which_trouse_public; //0 ou 1
    public int upper_cloth_public; // upper bosy cloth :   0 = pullover  1 = shirt    2 = t_shirt    3 = tanktop
    public int texture_public; //0 a 2
    ...
    IEnumerator start_random_clothing()
    {
        ...
        int skin_color = skin_color_public;
        ...
        int male_female = male_female_public; // 0 ou 1
       
        // does a hat fit for the hair     
        // determining haircolor
        int hairColor = hairColor_public;    // 0 = dark  1 = brown  2 = blonde
        ...
        if(male_female == 0)
        {
            ...
            int hair = hair_public; //0 a 2

            if (hair == 0)
            {
                hair_a.SetActive(true);
                // 0 = full hair    1 = under cut
                int hair_cut = hair_cut_public;//0 ou 1
                hat = true;
        ...
        if(male_female == 0)
        {
            int percent = percent_public; // 0 a 99
        ...
        int suit_or_cloth = suit_or_cloth_public; //0 ou 1
        ...
        if (suit_or_cloth == 0)
        {
            ...
            int which_suit = which_suit_public; //0 a 10
            ...
            if (which_suit == 0)
            {
                ...
                int which_texture = which_texture_public; //0 a 7
        ...
        if (suit_or_cloth == 1)
        {
            ...
            int shoes = shoes_public; //0 a 2

            if(shoes == 0)
            {
                shoes1.SetActive(true);
                int shoes1_texture = shoes1_texture_public; //0 a 7
            ...
            if (shoes == 1)
            {
                ...
                int shoes2_texture = shoes2_texture_public; //0 a 6
            ...
            if (shoes == 2)
            {
                ...
                int shoes3_texture = shoes3_texture_public; //0 a 5
            ...
            int chain = chain_public; //0 a 2

            if(chain == 0)
            {
                chain1.SetActive(true);
                int textures = texture_public; //0 a 3
            ...
            if(chain == 1)
            {
                ...
                int textures = texture_public; //0 a 2
            ...
            int scarfPercentage = scarfPercentage_public; //0 a 99

            if (scarfPercentage < 20)
            {
                scarf.SetActive(true);
                int textures = texture_public; //0 a 11
                scarf.GetComponent<Renderer>().materials[0].mainTexture = scarf_textures[textures];
            }

            int which_trouser = which_trouse_public; //1 ou 0

            // trousers
            if (which_trouser == 0)
            {
                trousers.SetActive(true);
                int texture = texture_public; //0 a 13
            ...
            if (which_trouser == 1)
            {
                ...
                int texture = texture_public; //0 a 10
            ...
            int upper_cloth = upper_cloth_public;
            
            if(upper_cloth == 0)
            {
                pullover.SetActive(true);
                int texture = texture_public; //0 a 16
            ...
            if (upper_cloth == 2)
            {
                ...
                int texture = texture_public; //0 a 20
