...
public class clothing : MonoBehaviour
{
    ...
    public int texture_public;
    public int skin_color_public;
    public int male_female_public;
    public int hairColor_public;
    public int hair_public;
    public int hair_cut_public;
    public int percent_public;
    public int suit_or_cloth_public;
    public int which_suit_public;
    public int which_texture_public;
    public int shoes_public;
    public int shoes1_texture_public;
    public int shoes3_texture_public;
    public int chain_public;
    public int shoes2_texture_public;
    public int scarfPercentage_public;
    public int which_trouse_public;
    public int upper_cloth_public;
